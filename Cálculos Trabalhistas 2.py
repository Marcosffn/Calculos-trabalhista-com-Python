...
def hora_extra(
    quantas, valor_hora, valor_horanoturna, qual=("0", "1", "2", "3", "4")
):
    """
...
def dsr(
    dia_uteis, domingos_feriado, quantidade_de_horas_extras=(), horas_extras=()
):
    dsrs1 = 0.0
    dsrs2 = 0.0
    dsrs3 = 0.0
    ...
    if horas_extra_1 != 0:
        dsrs1 = (
            (quantidade_de_horas_extras[0] / dia_uteis)
            * (horas_extras[0] / quantidade_de_horas_extras[0])
            * domingos_feriado
        )

    if horas_extra_2 != 0:
        dsrs2 = (
            (quantidade_de_horas_extras[1] / dia_uteis)
            * (horas_extras[1] / quantidade_de_horas_extras[1])
            * domingos_feriado
        )

    if horas_extra_3 != 0:
        dsrs3 = (
            (quantidade_de_horas_extras[2] / dia_uteis)
            * (horas_extras[2] / quantidade_de_horas_extras[2])
            * domingos_feriado
        )

    if horas_extra_4 != 0:
        dsrs4 = (
            (quantidade_de_horas_extras[3] / dia_uteis)
            * (horas_extras[3] / quantidade_de_horas_extras[3])
            * domingos_feriado
        )

    if horas_extra_5 != 0:
        dsrs5 = (
            (quantidade_de_horas_extras[4] / dia_uteis)
            * (horas_extras[4] / quantidade_de_horas_extras[4])
            * domingos_feriado
        )
...
print(
    "Digite o valor da carga horária diária, para contar o desconto em faltas: "
)
carga = float(input("> "))
...
print(
    "Trabalhou horas extras normais[0], hora extra noturna[1], hora notura[2],\
      hora extra domingo e feriados[3], hora extra domingo e feriados noturno[4]\
      ? [0/1/2/3/4]"
)
tipo_1 = input("> ")
...
horas_extra_1 = hora_extra(
    quantidade_de_horas_extras1, valor_da_hora, valor_hora_noturna, tipo_1
)
...
horas_extra_2 = hora_extra(
    quantidade_de_horas_extras2, valor_da_hora, valor_hora_noturna, tipo_2
)
...
horas_extra_3 = hora_extra(
    quantidade_de_horas_extras3, valor_da_hora, valor_hora_noturna, tipo_3
)
...
horas_extra_4 = hora_extra(
    quantidade_de_horas_extras4, valor_da_hora, valor_hora_noturna, tipo_4
)
...
horas_extra_5 = hora_extra(
    quantidade_de_horas_extras5, valor_da_hora, valor_hora_noturna, tipo_5
)

salario_adicional_mais_hora_extra = (
    salario_adicional
    + horas_extra_1
    + horas_extra_2
    + horas_extra_3
...
total_proventos = (
    salario_adicional_mais_hora_extra + dsr1 + dsr2 + dsr3 + dsr4 + dsr5
)
