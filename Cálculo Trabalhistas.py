...
if faltou == "s":
    ...
    falta_valor_dsr = salario / horas * (horas/5/5.5)
else:
    pass
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
...
total_proventos = salario + periculosidade + \
    ...
    valor_hora_extra2 + valor_hora_extra3 - (falta_valor + falta_valor_dsr)
...
faixa2 = (limite2 - limite1) * aliquota2
faixa3 = (limite3 - limite2) * aliquota3
faixa4 = (limite4 - limite3) * aliquota4
...
elif salario <= limite2 and salario > limite1:
    valor_residual = 0.
    valor_residual = (salario - limite1) * aliquota2
    inss = faixa1 + valor_residual

elif salario <= limite3 and salario > limite2:
    valor_residual = 0.
    valor_residual = (salario - limite2) * aliquota3
    inss = valor_residual + faixa1 + faixa2

elif salario <= limite4 and salario > limite3:
    valor_residual = 0.
    valor_residual = (salario - limite3) * aliquota4
